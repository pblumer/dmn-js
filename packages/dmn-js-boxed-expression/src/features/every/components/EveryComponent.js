...
function EveryComponent({ expression }) {
  ...
  return (
    <div className="every-expression">
      <div className="every-iterator">{ iteratorVariable }</div>
      <div className="every-in">
        <Expression expression={ inExpression } />
      </div>
      <div className="every-satisfies">
